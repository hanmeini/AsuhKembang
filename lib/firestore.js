...
// Update profil
// await updateUserHealthProfile("uid123", { height: 170, weight: 60 });

// Subscribe realtime scans
// const unsub = subscribeToTodaysScans("uid123", (scans) => console.log(scans), "profileId123");

// Subscribe realtime water intake
// const unsubWater = subscribeToTodaysWater("uid123", (val) => console.log("Air diminum:", val));

// Update water intake
// await updateTodaysWater("uid123", 1500);
