...
const pregnancyData = {
  1: {
    perkembangan_janin:
      "Janin masih berupa sel kecil yang baru mulai berkembang, sering disebut sebagai zigot.",
    gejala_umum_ibu:
      "Ibu mungkin belum merasakan gejala yang jelas, tapi bisa ada sedikit kram atau flek.",
  },
  12: {
    perkembangan_janin:
      "Janin seukuran plum, organ vital sudah terbentuk dan mulai berfungsi.",
    gejala_umum_ibu:
      "Mual berkurang, energi mulai kembali, tetapi mood swing masih mungkin terjadi.",
  },
  20: {
    perkembangan_janin:
      "Janin seukuran pisang, sudah bisa menendang dan bergerak lebih aktif.",
    gejala_umum_ibu:
      "Ibu mulai merasakan gerakan janin, perut makin terlihat membesar.",
  },
  32: {
    perkembangan_janin:
      "Janin seukuran labu kecil, berat badan bertambah cepat untuk persiapan lahir.",
    gejala_umum_ibu:
      "Sering buang air kecil, susah tidur, dan rasa tidak nyaman di punggung.",
  },
  40: {
    perkembangan_janin:
      "Janin siap lahir, ukuran penuh seperti semangka kecil.",
    gejala_umum_ibu:
      "Kontraksi palsu mungkin terjadi, tubuh bersiap untuk persalinan.",
  },
};
...
export async function POST(request) {
  ...
  if (!week || week < 1 || week > 42) {
    return NextResponse.json(
      { error: "Minggu kehamilan tidak valid." },
      { status: 400 },
    );
  }
