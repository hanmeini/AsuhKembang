    ...
    <div className="mt-8">
      ...
      <div className="mt-4 space-y-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold">Tinggi Zat Besi</p>
            <p className="text-sm text-gray-600">
              Sangat penting untuk mencegah anemia dan mendukung perkembangan
              kognitif.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold">Sumber Protein Hewani</p>
            <p className="text-sm text-gray-600">
              Mendukung pertumbuhan sel dan otot si kecil.
            </p>
          </div>
        </div>
      </div>
...
export default function RecipeDetailPage({ params }) {
  ...
  const galleryImages = [
    recipe.imageUrl,
    "/images/resep-placeholder-1.jpg",
    "/images/resep-placeholder-2.jpg",
  ];
  const fallbackImage =
  ...
  return (
    <AuthGuard>
      ...
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="md:hidden bg-gray-50 min-h-screen pb-20"
      >
        <div className="relative">
          <Link
            href="/resep"
            className="absolute top-4 left-4 z-20 bg-white/70 p-2 rounded-full shadow-lg backdrop-blur-sm"
          >
      ...
      >
        <header className="bg-teal-600 text-white p-20 md:rounded-b-[4rem] relative">
          <Link
            href="/resep"
            className="absolute top-6 left-6 z-20 bg-white/20 p-2 rounded-full hover:bg-white/40 transition"
          >
