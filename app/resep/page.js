...
const RecipeCard = ({ recipe }) => {
  const [imgSrc, setImgSrc] = useState(
    recipe.imageUrl || "/images/placeholder-resep.jpg",
  );
  const fallbackImage =
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2 mt-2">
          {recipe.author?.avatar && !hasAvatarError ? (
            <Image
              src={recipe.author.avatar}
              alt={recipe.author?.name || "Kontributor"}
              width={24}
              height={24}
          ...
          <p className="text-xs text-gray-500">
            oleh {recipe.author?.name || "Kontributor"}
          </p>
        </div>
      </div>
    </Link>
        ...
        >
          <div className="">
            <header
              ...
              style={{
                backgroundImage: `url('/images/anaksehat.jpg')`,
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            >
              <svg
                className="absolute animate-rotate-swing left-0 md:left-1/6 top-1/8 md:top-1/4"
                width="67"
                height="68"
                viewBox="0 0 67 68"
                fill="none"
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <p className="mt-4 max-w-xl text-lg opacity-90">
                  Yuk, jelajahi resep makanan yang paling sehat untuk memenuhi
                  gizi harian.
                </p>
                <div className="mt-8 w-full max-w-lg">
                  <form onSubmit={handleSearch} className="relative">
                    ...
                    <button
                      type="submit"
                      className="absolute right-2 top-1/2 -translate-y-1/2 bg-teal-600 hover:bg-teal-500 text-white p-2 rounded-full transition-colors"
                    >
            ...
            {isLoading ? (
              <div className="p-10">
                <h1 className="md:font-bold font-semibold text-lg md:text-2xl">
                  Memuat resep...
                </h1>
              ...
              <div className="p-10">
                <h1 className="md:font-bold font-semibold text-lg md:text-2xl">
                  Jelajahi berbagai resep buatan bunda hebat
                </h1>
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {recipes.map((recipe) => (
