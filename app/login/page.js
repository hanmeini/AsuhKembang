...
const Login = () => {
    ...
    useEffect(() => {
        if (userProfile) {
            console.log("Login dan profil siap, mengarahkan ke /dashboard");
        ...
        <div className="w-full h-screen grid grid-cols-1 lg:grid-cols-2">
            ...
            <div 
                className="
                    ...
                    bg-cover bg-center bg-[url('/images/loginbg.jpg')] lg:bg-none lg:bg-white"
                >
                    ...
                    <div className="w-full">
                        ...
                        <form onSubmit={handleEmailLogin} className="w-full flex flex-col gap-4">
                            ...
                            <div>
                                ...
                                <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Masukkan kata sandi" className="w-full rounded-full bg-gray-100 px-5 py-3 focus:outline-none focus:ring-2 focus:ring-teal-500" required />
                            </div>
