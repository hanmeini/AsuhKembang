        ...
        <div className="relative mt-8">
          ...
          <div className="flex items-center justify-end mt-8 space-x-6">
            ...
            <div className="flex items-center space-x-2">
              <button aria-label="Slide berikutnya" className="swiper-button-prev-custom p-2 rounded-full hover:bg-gray-100 transition-colors">
              ...
              <button aria-label="Slide berikutnya" className="swiper-button-next-custom p-2 rounded-full hover:bg-gray-100 transition-colors">
